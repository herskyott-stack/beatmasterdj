...
export const SignupEmail = ({ siteName, siteUrl, recipient, confirmationUrl }: Props) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Confirm your email for BeatMaster DJ</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={body}>
          ...
          <Text style={text}>Thanks for signing up with <Link href={siteUrl} style={link}>{siteName}</Link>.</Text>
          <Text style={text}>Please confirm <Link href={`mailto:${recipient}`} style={link}>{recipient}</Link> by clicking below:</Text>
