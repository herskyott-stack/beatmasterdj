...
- [x] Add `/pricing-guide` with lead form and supplied guide content.
- [x] Add `/web-design` with packages, add-ons, process, and consultation links.
- [x] Add both pages to navigation and footer.
